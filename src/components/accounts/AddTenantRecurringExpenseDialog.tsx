...
interface AddTenantRecurringExpenseDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  categories: TenantExpenseCategory[];
  expense?: TenantRecurringExpense | null;
  onSubmit: (data: any) => Promise<void>;
}

export function AddTenantRecurringExpenseDialog({
  open,
  onOpenChange,
  categories,
  expense,
  onSubmit,
}: AddTenantRecurringExpenseDialogProps) {
  ...
  useEffect(() => {
    if (expense) {
      form.reset({
        ...
        next_due_date: expense.next_due_date ? new Date(expense.next_due_date) : null,
        notes: expense.notes || '',
      });
    } else {
      form.reset({
    ...
    <ResponsiveDialog open={open} onOpenChange={onOpenChange}>
      <ResponsiveDialogContent className="max-w-lg">
        <ResponsiveDialogHeader>
          ...
          <ResponsiveDialogDescription>
            {isEditing ? 'Update the recurring expense template.' : 'Create a new recurring expense template.'}
          </ResponsiveDialogDescription>
        </ResponsiveDialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Landlord" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
