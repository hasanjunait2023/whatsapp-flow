...
import { InternalMessageBubble } from '@/components/internal-chat/InternalMessageBubble';
import { InternalChatInput } from '@/components/internal-chat/InternalChatInput';
import { TypingIndicator } from '@/components/internal-chat/TypingIndicator';
import { PresenceIndicator } from '@/components/internal-chat/PresenceIndicator';
...
interface AdminChatRoomViewProps {
  room: ChatRoom;
...
export function AdminChatRoomView({
  room,
  messages,
  loading,
  onSendMessage,
  onLeaveGroup,
}: AdminChatRoomViewProps) {
  const { user } = useAuth();
  const { isOnline, getTypingUsers } = useAdminPresence();
