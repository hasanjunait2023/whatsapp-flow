...
export const SUPPORT_PHONE = "+880 1700-000000";
export const SUPPORT_WHATSAPP = "8801922001161"; // Without + for wa.me API

// URLs (can be updated when you have your own domain)
export const APP_URL = "https://ecomexautomation.com";
export const DOCS_URL = "https://docs.ecomexautomation.com";
export const PRIVACY_URL = "https://ecomexautomation.com/privacy";
export const TERMS_URL = "https://ecomexautomation.com/terms";

// Internal references (never shown to tenants)
