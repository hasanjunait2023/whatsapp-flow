...
import { useAdminQuickReplies, QuickReply, QuickReplyInput, QuickReplyContentType, MediaItem } from '@/hooks/useAdminQuickReplies';
...
/**
 * Admin-specific Quick Replies Manager.
 * Uses `useAdminQuickReplies` hook which operates on the System Tenant.
 */
export default function AdminQuickRepliesManager() {
  const { quickReplies, loading, createQuickReply, updateQuickReply, deleteQuickReply } = useAdminQuickReplies();
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Pre-saved message templates for admin business communication
            </CardDescription>
          </div>
